<template>
  <div class="home">
    ...
    <section class="h-full relative overflow-hidden">
      ...
      />
      <div
        class="absolute top-0 left-0 border h-full w-full px-12 py-52 lg:px-40 md:px-32 lg:py-24"
      >
        <h1 class="text-5xl lg:text-4xl text-white font-semibold py-1">
          Project SICAT
        </h1>
        ...
        <button class="b bg-blue-500 py-2 px-3 rounded-md text-white m-1">
